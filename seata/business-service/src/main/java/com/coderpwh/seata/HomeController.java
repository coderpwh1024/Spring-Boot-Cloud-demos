...
public class HomeController {
    ...
    public HomeController(RestTemplate restTemplate, BusinessApplication.OrderService orderService, BusinessApplication.StorageService storageService) {
    ...
    public String rest() {
        String result = restTemplate.getForObject("http://127.0.0.1:18082/storage/" + COMMODITY_CODE + "/" + ORDER_COUNT,
                String.class);
